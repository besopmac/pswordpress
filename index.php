<?php get_header(); ?>
        ...
        <div id="carousel-destaque" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="img/yoga-template.jpg" alt="Yoga Image">
                    <div class="carousel-caption">
                    </div>
                </div>
                <div class="item">
                    <img src="img/pilates-template.jpg" alt="Pilates Image">
                    <div class="carousel-caption">
                    </div>
                </div>
            </div>

            <a class="left carousel-control" href="#carousel-destaque" role="button" data-slide="prev"><img class="carousel-button" aria-hidden="true" src="img/back-white.svg"></a>
            <a class="right carousel-control" href="#carousel-destaque" role="button" data-slide="next"><img class="carousel-button" aria-hidden="true" src="img/next-white.svg"></a>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <section class="box-cursos">
                            <img src="img/img-cursos.jpg" class="img-responsive" alt="Yoga Image">
                            <h3>Pilates</h3>
                    ...
                    <div class="col-md-4 col-md-offset-1">
                        ...
                        <section class="box-studio">
                            <a href="studio.html"><img src="img/img-studio.jpg" class="img-responsive" alt=""></a>
    ...
    <section class="container box-depoimento">
        <div id="text-carousel" class="carousel carousel-dep slide" data-ride="carousel">
            ...
            <!-- Controls -->
            <a class="left carousel-control" href="#text-carousel" data-slide="prev"><img class="carousel-button" src="img/back.svg"></a>
            <a class="right carousel-control" href="#text-carousel" data-slide="next"><img class="carousel-button" src="img/next.svg"></a>
        </div>
    </section>
